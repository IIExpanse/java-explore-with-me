CREATE TYPE IF NOT EXISTS "event_state" AS ENUM (
    'PENDING',
    'PUBLISHED',
    'CANCELED'
    );
...
(
    ...
    CONSTRAINT event_not_created_in_future CHECK ("created_on" <= CURRENT_TIMESTAMP),
...
(
    ...
    CONSTRAINT request_not_created_in_future CHECK ("created" <= current_timestamp)
);
